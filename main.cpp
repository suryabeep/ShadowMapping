...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // cube2
        modelMat = glm::translate(glm::mat4(1.0f), glm::vec3(-2.0f, 1.0f, -3.0f));
        basicShader->setMat4("model", modelMat);
        modelView = view * modelMat;
        normalMatrix = glm::inverse(glm::transpose(modelView));
        basicShader->setMat4("normalMatrix", normalMatrix);
        cube2->draw();

        // floor
        auto trans = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -10.0f, -8.0f));
        auto scale = glm::scale(glm::mat4(1.0f), glm::vec3(10.0f));
